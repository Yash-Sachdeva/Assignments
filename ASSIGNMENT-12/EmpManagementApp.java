...
abstract class Employee{
        ...
        public static void loadEmployeesFromFile() {
                try (BufferedReader br = new BufferedReader(new FileReader("employees.csv"))) {
                    ...
                    while ((line = br.readLine()) != null) {
                        ...
                        if (e != null) {
                            setEmployeeDetails(e, id, name, age, salary);
                            emp.put(id, e);
                        }
                    }
                } catch (IOException e) {
        ...
        private static void setEmployeeDetails(Employee e, int id, String name, int age, float salary) {
        ...
        public static void saveEmployeesToFile() {
            try (BufferedWriter bw = new BufferedWriter(new FileWriter("employees.csv"))) {
                for (Employee e : emp.values()) {
                    bw.write(e.eid + "," + e.name + "," + e.age + "," + e.salary + "," + e.designation);
                    bw.newLine();
                }
            } catch (IOException e) {
...
public class EmpManagementApp {
    public static void main(String[] args) {
        ...
        // Save employees to file on exit
